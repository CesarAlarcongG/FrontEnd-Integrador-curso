...
    estado: 'DISPONIBLE' // Nuevo campo con valor por defecto
  });
...
      setFormData({ nombre: '', apellido: '', dni: '', numeroLicenciaConduccion: '', estado: 'DISPONIBLE' });
    } catch (error) {
...
      estado: conductor.estado || 'DISPONIBLE' // Asigna el estado actual o 'DISPONIBLE' si no existe
    });
    setShowForm(true);
  };
...
                    ${conductor.estado === 'DISPONIBLE' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
                  >
